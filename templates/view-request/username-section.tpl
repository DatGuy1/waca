...
<a id="UsernameCreateLocal" class="btn btn-sm btn-outline-secondary visit-tracking" target="_blank"
   href="{$mediawikiScriptPath}?title=Special:CreateLocalAccount&amp;target={$requestName|escape:'url'}&amp;wpreason={$createAccountReason|escape:'url'}[[ACC:{$requestId}|{$requestId}]]">
